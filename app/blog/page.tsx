...
const pageStyles = `
  ...
  .bp-hero h1 { font-family: 'Industry', 'Inter', sans-serif; font-size: clamp(2.2rem, 5vw, 3.5rem); font-weight: 700; color: #fff; text-transform: uppercase; line-height: 1.05; margin-bottom: 1rem; }
  ...
  .bp-card-body h3 { font-family: 'Industry', 'Inter', sans-serif; font-size: 1.1rem; font-weight: 800; text-transform: uppercase; line-height: 1.2; margin-bottom: 0.6rem; }
