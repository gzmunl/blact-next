...
const pageStyles = `
  ...
  .np-hero h1 { font-family: 'Exo 2', sans-serif; font-size: clamp(2.2rem, 5vw, 3.5rem); font-weight: 700; color: #fff; text-transform: uppercase; line-height: 1.05; margin-bottom: 1rem; }
  ...
  .np-card-body h3 { font-family: 'Exo 2', sans-serif; font-size: 1.1rem; font-weight: 800; text-transform: uppercase; line-height: 1.25; margin-bottom: 0.4rem; letter-spacing: 0.03em; }
  ...
  .np-sidebar-box h4 { font-family: 'Exo 2', sans-serif; font-size: 0.85rem; font-weight: 800; text-transform: uppercase; letter-spacing: 2px; color: #e2771d; margin-bottom: 1.2rem; }
