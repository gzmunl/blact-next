...
const loginStyles = `
  ...
  .login-logo { font-family: 'NASA', 'Industry', sans-serif; font-size: 1.4rem; font-weight: 700; color: #fff; text-transform: uppercase; letter-spacing: 2px; text-align: center; margin-bottom: 0.5rem; }
  ...
  .login-input { width: 100%; padding: 0.8rem 1rem; background: #0a0a0a; border: 1px solid #222; color: #fff; font-size: 0.9rem; outline: none; transition: border-color 0.3s; font-family: 'Barlow', sans-serif; }
  .login-input:focus { border-color: #e2771d; }
  .login-btn { width: 100%; padding: 0.9rem; background: #e2771d; color: #fff; border: none; font-size: 0.8rem; font-weight: 700; letter-spacing: 2px; text-transform: uppercase; cursor: pointer; transition: background 0.3s; margin-top: 1rem; font-family: 'Barlow', sans-serif; }
