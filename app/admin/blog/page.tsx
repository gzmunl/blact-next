  ...
  return (
    <AdminLayout title="Blog Yazıları">
      <div style={{ marginBottom: '1.5rem' }}>
        <a href="/admin/blog/new" className="admin-btn admin-btn-primary">+ Yeni Blog Yazısı</a>
      </div>
      ...
      {loading ? (
        ...
        <div className="admin-empty">
          ...
          <a href="/admin/blog/new" className="admin-btn admin-btn-primary">İlk Yazıyı Ekle</a>
        </div>
      ) : (
              ...
              <tr key={post.id}>
                ...
                <td>
                  <div style={{ display: 'flex', gap: '0.5rem' }}>
                    <a href={`/admin/blog/${post.id}/edit`} className="admin-btn admin-btn-outline admin-btn-sm">Düzenle</a>
